...
using Name2LoDTensor = std::unordered_map<std::string, const LoDTensor*>;
...
static void CheckTensorEquivalent(
    const Name2LoDTensor& paddle_tensors, /*paddle name -> const LoDTensor**/
...
static void InitializeOutputVar(
